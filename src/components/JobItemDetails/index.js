...
import SimilarProducts from '../SimilarJobs'
    ...
    return (
      <>
        <div className="job-detail-card-container">
          ...
          <div className="jobs-location-and-package-container">
        ...
        <div className="similar-job-cards-container">
          <h1 className="description-text">Similar Jobs</h1>
        </div>
        <ul className="similar-products-container-list">
